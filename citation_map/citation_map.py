...
def institution_text_to_geocode(author_institution_tuple_list: List[Tuple[str]], num_processes: int = 16) -> List[Tuple[str]]:
    '''
...
def __text_to_geocode(author_institution_tuple):
...
def generate_citation_map(scholar_id: str,
    ...
    author_institution_tuple_list = find_all_citing_institutions(author_profile['publications'], num_processes=num_processes)
